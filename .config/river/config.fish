# Input stuff
riverctl input pointer-1452-850-Apple_MTP_multi-touch disable-while-typing disabled

# My addiction to zig is not getting better
...
# Make Zen's pip windows floating.
